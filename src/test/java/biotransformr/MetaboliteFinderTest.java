...
public class MetaboliteFinderTest extends MetaboliteFinder {
	...
	public static void main(String[] args) throws Exception{
		...
		mft.findSuperbioMetabolites(atc, masses, 0.01, true, "data/epicatechin_metabolites_identification.sdf", FinderOption.MASS);
	

		formulas.add("C11H12O3");
		mft.findAllHumanMetabolites(atc, masses, 0.01, 2, false, "data/epicatechin_allHuman_met_id.sdf", FinderOption.MASS);
