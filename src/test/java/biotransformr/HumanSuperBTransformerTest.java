...
public class HumanSuperBTransformerTest extends HumanSuperBioTransformer{
	...
	public static void main(String[] args) throws Exception{
		...
		IAtomContainer molecule = smiParser.parseSmiles("OC(=O)CCC1=CC=CC=C1");
		...
		ArrayList<Biotransformation> biotansformations = hsbt.simulateHumanAndGutMicrobialMetabolism(mt);
		
		for(Biotransformation bt : biotansformations){
			bt.display();
			System.out.println();
		}
