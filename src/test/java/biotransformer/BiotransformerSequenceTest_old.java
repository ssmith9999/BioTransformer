...
public class BiotransformerSequenceTest_old{ 
	...
	public BiotransformerSequenceTest_old() {
		
	}
	public static void main(String[] args) throws Exception {
		BiotransformerSequenceTest_old btst =  new BiotransformerSequenceTest_old();
