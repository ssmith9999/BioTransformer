...
public class Enzyme {
	...
	public Enzyme(EnzymeName enzName) {
...
//		Enzyme(enzName, null ,uniprot_ids, cellularLocations, reactions);
		this.name = EnzymeName.valueOf(enzName);
...
//	}
	...
	public void display(){
		...
		System.out.println(String.format("%-30s\t%-35s","Systematic name:",this.acceptedName));
		System.out.println(String.format("%-20s","Reactions:"));
		
		for(MetabolicReaction m : this.getReactionSet())
		System.out.println(String.format("%-60s",m.name));
	}
